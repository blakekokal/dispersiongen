...
if st.button("Generate Shot Patterns"):
    ...
    # -----------------------------
    # Fixed-axis dispersion plots
    # -----------------------------
    st.subheader("Shot Dispersion Charts (Fixed Axes)")

    X_LIMIT = 50    # yards left/right
    Y_LIMIT = 25    # yards short/long
